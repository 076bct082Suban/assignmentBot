module.exports = {
    ...
    execute(message, args, schedule, schedule_list) {
        ...
        try{
            ...
            schedule_list[`${subject} ${teacher} ${args[3]} ${time_arr}`] = [];
            if(time_arr[1] - 15 < 0) {
                ...
                schedule_list[`${subject} ${teacher} ${args[3]} ${time_arr}`].push(alert);
            }
            else{
            ...
            schedule_list[`${subject} ${teacher} ${args[3]} ${time_arr}`].push(event);
